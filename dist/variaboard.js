...
var BooleanControl = function (_Control) {
  ...
  function BooleanControl(variaboard, config) {
    ...
    _this.description = config.description !== undefined ? config.description : null;
  ...
  _createClass(BooleanControl, [{
    ...
    value: function listen() {
      ...
      this.dom.checkbox.addEventListener('focus', function (e) {
        return _this2.onValueFocus(e);
      });
      this.dom.checkbox.addEventListener('blur', function (e) {
        return _this2.onValueBlur(e);
      });
      this.dom.checkboxWrap.addEventListener('click', function (e) {
        return _this2.onCheckboxWrapClick(e);
      });
    }
  }, {
    ...
    key: 'onCheckboxWrapClick',
    value: function onCheckboxWrapClick() {
    ...
    value: function set(val) {
      ...
      var title = this.title + ': ' + this.value + this.suffix;
      if (this.description) {
...
var RangeControl = function (_Control) {
  ...
  function RangeControl(variaboard, config) {
    ...
    _this.easedDuration = config.easedDuration !== undefined ? config.easedDuration : 300;
  ...
  _createClass(RangeControl, [{
    ...
    value: function set(val) {
      ...
      // set the title attribute for the control
      var title = this.title + ': ' + this.value.toFixed(this.places) + this.suffix;
      if (this.description) {
